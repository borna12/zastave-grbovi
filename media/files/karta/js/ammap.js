...
(function () {
    ...
    d.AmMap = d.Class({
        ...
        showDescription: function (a) {
            ...
            if (a.customData) {
                podrucje = a.customData.smještaj;
                ...
                if (stranica!=""){stranica=parseInt(stranica)+1}
                podatci = "<p class='metapodatci'><span id='drzava'><strong>SLUŽBENI NAZIV</strong>: " + drzava + "<br></span><span id='podrucje'><strong>SMJEŠTAJ</strong>: " + podrucje + "<br> </span><span id='status'><strong>STATUS</strong>: " + status + "<br> </span><span id='grad'><strong>GLAVNI GRAD</strong>: " + grad + "<br> </span><span id='srediste'><strong>SREDIŠTE</strong>: " + srediste + "<br> </span><span id='povrsina'><strong>POVRŠINA</strong>: " + povrsina + " km<sup>2</sup><br></span><span id='stanovnici'><strong>BROJ STANOVNIKA</strong>: " + stanovnici + "<br> </span><span id='gustoca'><strong>GUSTOĆA NASELJENOSTI</strong>: " + gustoca + "<br> </span><span id='jezik'><strong>SLUŽBENI JEZIK</strong>: " + jezik + "<br> </span><span id='novac'><strong>NOVČANA JEDINICA</strong>: " + novac + "<br> </span><span id='politika'><strong>POLITIČKO UREĐENJE</strong>: " + politika + "<br> </span><span id='clanstvo_UN'><strong>ČLANSTVO U UN</strong>: " + clanstvo_UN + "<br> </span></p><p style='text-align:center' id='zastava'><img src='zastave/" + zastava + "'></p><p id='opis_zastava'>" + opis_zastava + "</p><p style='text-align:center' id='grb'><img src='grbovi/" + grb + "'></p><p id='grb_opis'>" + grb_opis + "</p><p style='text-align:center' id='stranica'><a href='../../../media/files/knjiga/#flipbook-df_manual_book/" + stranica + "' target='_blank'>Zastave i grbovi (2006)</a></p><p style='text-align:center' id='enciklopedija'><a href='https://www.enciklopedija.hr/Natuknica.aspx?ID=" + enciklopedija + "' target='_blank'>doznaj više...</a></p>";
